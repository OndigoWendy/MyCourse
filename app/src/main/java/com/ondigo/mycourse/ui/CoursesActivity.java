...
public class CoursesActivity extends AppCompatActivity {
   ...
   MyCoursesArrayAdapter adapter = new  MyCoursesArrayAdapter(this, android.R.layout.simple_list_item_1, restaurants, cuisines); // the arguments must match constructor's parameters!
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Toast.makeText(CoursesActivity.this, restaurant, Toast.LENGTH_LONG).show();
            }
        });
